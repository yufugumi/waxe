...
export default function Home() {
  return (
    <><Head>
      ...
      <meta property="og:title" content="Wellington.govt.nz accessibility report" key="title" />
      <meta property="twitter:title" content="Wellington.govt.nz accessibility report" />
